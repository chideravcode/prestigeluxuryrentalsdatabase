...
public class BRANCHFXMLController implements Initializable {
    ...
    @FXML
    private AnchorPane branchesview;
    @FXML
    ...
    @FXML
    private TextField textfieldbranchnumber;
    @FXML
    private AutoCompleteTextField textfieldaddress;
    @FXML
    private AutoCompleteTextField textfieldphonenumber;
    @FXML
    private TableView tableviewbranches;
    @FXML
    private TableColumn columnbranchnumber;
    @FXML
